...
#let proposal_writing = cv_section_list("PROPOSAL WRITING",
  (
    cv_entry(
      [*GenZero Proposal* #text(weight: "regular")[_PIs: \[Benjamin Lubin#diamond()Marco Caccamo#diamond()Sandro Pinto#diamond()Renato Mancuso\]_] #h(1fr) 2024],
      [#text(style: "italic", weight: "medium")[Selected proposal] and #text(style: "italic", weight: "medium")[Best Presentation Award] winner at the GenZero Workshop. I contributed to the development of the proposal and led the successful prototype demonstration, coordinating efforts between PhD. students at Boston University, Technical University of Munich, and University of Minho. The project proposes a framework that separates data ownership, processing, and usage concerns, demonstrated through ML workloads. We advanced to the final phase following the competitive selection process.]
    ),
    cv_entry(
      [*BU Technology Development Ignition Award* #text(weight: "regular")[_PI: \[Renato Mancuso\]_] #h(1fr) 2024],
    ...
    cv_entry(
      [*Efficient Control for Small-Scale Limbed Robots* #text(weight: "regular")[_PIs: \[Renato Mancuso#diamond()Sabrina Neuman\]_] #h(1fr) 2024],
    ...
    cv_entry(
      [*Solar-Powered UAV for Sustainable Agriculture* #text(weight: "regular")[_PIs: \[Renato Mancuso#diamond()Marco Caccamo\]_] #h(1fr) 2023],
    ...
    cv_entry(
      [*Certified Survivability* #text(weight: "regular")[_PIs: Renato Mancuso#diamond()Chuchu Fan_] #h(1fr) 2022],
